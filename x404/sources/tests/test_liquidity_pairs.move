...
module bonding_curve_launchpad::test_liquidity_pairs {
    ...
    public fun test_insignificant_fa_swap(deployer: &signer) {
        ...
        liquidity_pairs::get_amount_out(1_000_000_000 + INITIAL_VIRTUAL_FA_LIQUIDITY, 10_000_000_000, true, 0, 1_000_000_000, 50_00_000_000 + 25_00_000_000);
    }
    ...
    public fun test_insignificant_apt_swap(deployer: &signer) {
        liquidity_pairs::initialize_for_test(deployer);
        liquidity_pairs::get_amount_out(25_000_000_000, 30_000_000_000, true, 300_000_000, 300_00_000_000, 50_00_000_000 + 10_000_000_000);
    }
